...
//					printTextField("Version: " + str);
		...
		progressBar.setValue(25);
		{
			...
			try {
				...
				verfile = new URL("https://raw.githubusercontent.com/Hunterszone/GunMan/master/version.txt");
	...
	public Launcher() {
...

		{
			...
			try {
				...
				{
					URL url = new URL("https://raw.githubusercontent.com/Hunterszone/GunMan/master/dlls.txt");
					HttpURLConnection conn = (HttpURLConnection) url.openConnection();
					conn.setRequestMethod("HEAD");
...
//						progressBar.setValue(100);
				...
				for (final String str : downloadDLLs) {
					...
					URL url = new URL("https://github.com/Hunterszone/GunMan/raw/master/" + str);
					final HttpURLConnection conn = (HttpURLConnection) url.openConnection();
					progressBar.setValue(30);
					conn.setRequestMethod("HEAD");
					...
					if (!fi.exists() || fi.length() != conn.getContentLength()) {
						...
						Thread t = new Thread() {
							@Override
							public void run() {
								download("https://github.com/Hunterszone/GunMan/raw/master/" + str, "/" + str,
										conn.getContentLength());
							}
						};
						t.start();
		...
		try {
			URL url = new URL("https://raw.githubusercontent.com/Hunterszone/GunMan/master/GunMan64bit.jar");
			final HttpURLConnection conn = (HttpURLConnection) url.openConnection();
			conn.setRequestMethod("HEAD");
		...
		try {
			URL url = new URL("https://raw.githubusercontent.com/Hunterszone/GunMan/master/GunMan32bit.jar");
			final HttpURLConnection conn = (HttpURLConnection) url.openConnection();
			conn.setRequestMethod("HEAD");
