...
@RunWith(Suite.class)
@Suite.SuiteClasses({ ActorTest.class, AreaTest.class, BridgeTest.class, LoadResourcesTest.class, NutTest.class,
		PlayerTest.class, WallTest.class, WaterTest.class })

public class AllTests {
	public static Class<?>[] getClasses() {
		Class<?>[] allClasses = { ActorTest.class, AreaTest.class, BridgeTest.class, LoadResourcesTest.class,
