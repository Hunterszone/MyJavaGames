...
class AutoSuggestor {
 ...
 public AutoSuggestor(JTextField textField, Window mainWindow, ArrayList < String > commands, Color popUpBackground, Color textColor, Color suggestionFocusedColor, float opacity) {
 ...
 private void checkForAndShowSuggestions() {
  ...
  suggestionsPanel.removeAll(); //remove previos commands/jlabels that were added
