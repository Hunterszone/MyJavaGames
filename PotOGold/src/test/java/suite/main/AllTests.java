...
@RunWith(Suite.class)
@Suite.SuiteClasses({ BombTest.class, EffectsTest.class, GiftTest.class, LepriconTest.class,
		LivesTest.class, LoadIconTest.class, PointsTest.class, GameOverTest.class, GamePauseTest.class, TimerTest.class,
		YouWonTest.class })

public class AllTests {
	public static Class<?>[] getClasses() {
		Class<?>[] allClasses = { BombTest.class, EffectsTest.class, GiftTest.class,
